...
def predict():
    if request.method == "POST":
        ...
        Item_Type_Combined = request.form["Item_Type"]
        ...
        with open("grid_rbgr.pkl", "rb") as model_file:
            model = pickle.load(model_file)

        X = model.predict([[Item_Weight,Item_Visibility,Item_MRP,Outlet_Years,
        ...
        return render_template('output.html',output=X[0])
